...
import 'package:epiece_shopping_app/controllers/search_product_controller.dart';
...
import 'package:epiece_shopping_app/data/repos/auth_repo.dart';
import 'package:epiece_shopping_app/data/repos/cart_repo.dart';
import 'package:epiece_shopping_app/data/repos/location_repo.dart';
import 'package:epiece_shopping_app/data/repos/order_controller.dart';
import 'package:epiece_shopping_app/data/repos/order_repo.dart';
import 'package:epiece_shopping_app/data/repos/popular_product_repo.dart';
import 'package:epiece_shopping_app/data/repos/product_repo.dart';
import 'package:epiece_shopping_app/data/repos/search_product_repo.dart';
import 'package:epiece_shopping_app/data/repos/user_repo.dart';
