...
class Dimensions {
  ...
  //detail piece
  static const double DETAIL_Piece_IMG=400;

  static double detailPieceImg=screenSizeWidth>WEB_MAX_WIDTH?double.maxFinite-400:screenSizeHeight/2.11;
  static double detailPieceImgWidth=screenSizeWidth>WEB_MAX_WIDTH?double.maxFinite-400:double.maxFinite;
  static double detailPieceImgPad=screenSizeWidth>WEB_MAX_WIDTH?MARGIN_SIZE_EXTRA_LARGE:0;
  ...
  static  double SPLASH_IMG_WIDTH=screenSizeWidth>WEB_MAX_WIDTH?SizeConfig.screenWidth:SizeConfig.screenWidth*2;
