...
class SearchProductController extends GetxController implements GetxService {
  ...
  bool _isAvailablePieces = false;
  bool _isDiscountedPieces = false;
  ...
  bool get isAvailablePieces => _isAvailablePieces;
  bool get isDiscountedPieces => _isDiscountedPieces;

  void toggleAvailablePieces() {
    _isAvailablePieces = !_isAvailablePieces;
    update();
  }

  void toggleDiscountedPieces() {
    _isDiscountedPieces = !_isDiscountedPieces;
    update();
  }
  ...
  void setSearchMode(bool isSearchMode) {
    ...
    if(isSearchMode) {
      ...
      _searchProductList = [];
      _sortIndex = -1;
      _isDiscountedPieces = false;
      _isAvailablePieces = false;
      _rating = -1;
      _upperValue = 0;
      _lowerValue = 0;
    }
