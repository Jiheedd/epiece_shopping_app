...
class MainPiecePage extends StatefulWidget {

  @override
  State<MainPiecePage> createState() => _MainPiecePageState();
}

class _MainPiecePageState extends State<MainPiecePage> {
    ...
    return Transform(
      ...
      child: Padding(
        ...
        child:   GestureDetector(
          onTap: (){
            Get.toNamed(RouteHelper.getRecommendedPieceRoute(index, "recommended"));
          },
          child: Align(
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color:index.isEven?Color(0xff018fb8):Color(0xffdc1d24),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 10,),
                              TextWidget(text: product.stars.toString(), color: Color(0xFFccc7c5)),
                              SizedBox(width: 10,),
                          ...
                          Row(
                            ...
                            children: [
                              IconAndTextWidget(text: "Tôlerie",
                                color: AppColors.textColor,
                                icon: Icons.garage_rounded,
                                iconColor: AppColors.greenSuccess,
                              ),

                              IconAndTextWidget(text: trimFirstWord(product.location.toString(),' '),
                                color: AppColors.textColor, icon: Icons.location_on,
                                iconColor: AppColors.mainColor,),
                              IconAndTextWidget(text: trimFirstWord(product.price.toString(), '.'),color: AppColors.textColor,
                                icon: Icons.phone,
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                      ...
                      child: TextWidget(text: "Piece pairing", color: AppColors.textColor)
                  ),
                ],
              )
          ),
                        ...
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    fit: BoxFit.fill,
                                    image: NetworkImage(popularProducts.popularProductList[index].img)
                                )
                            ),
                          ),
                          Expanded(
