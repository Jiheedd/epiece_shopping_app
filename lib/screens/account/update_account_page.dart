...
class _UpdateAccountPageState extends State<UpdateAccountPage> {
  ...
  void pickUploadProfilePic(UserController userController) async {
    ...
    Reference ref = FirebaseStorage.instance
          .ref("UserImage/").child(userController.userInfoModel!.id.toString()+".jpg");
    //    .ref("UserImage/");
           ...
           children: [
             ...
             Center(child: Stack(children: [
               ...
               Positioned(
                 ...
                 child: InkWell(
                   onTap: (){
                     pickUploadProfilePic(userController);
                   },
                   ...
                   child: Column(
                     crossAxisAlignment: CrossAxisAlignment.start,
                       children: [
                         ...
                         AppTextField(readOnly:true,hintText: "Phone", textController: _phoneController, icon: Icons.phone,textInputType: TextInputType.phone),
  ...
  void _updateProfile(UserController userController) async {
    ...
    if (userController.userInfoModel?.fName == _firstName &&
        ...
        userController.userInfoModel?.email == _emailController.text && _isPickChanged==false) {
