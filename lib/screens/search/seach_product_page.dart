...
import 'package:epiece_shopping_app/screens/search/search_result_widget.dart';
import 'package:epiece_shopping_app/screens/search/widget/search_field.dart';
  ...
  void _actionSearch(SearchProductController searchController, bool isSubmit) {
    if(searchController.isSearchMode || isSubmit) {
      if(_searchController.text.trim().isNotEmpty) {
        ...
        showCustomSnackBar('Type is a keyword to search for piece');
      }
    }
  }
}
