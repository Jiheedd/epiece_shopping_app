...
class SearchedPiece extends StatelessWidget {
  int pageId;
  String page;
  String route;

  SearchedPiece({Key? key, required this.pageId, required this.page, required this.route})
      : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    /*
    print(image);
    print(AppConstants.UPLOADS_URL);
    print (productItem.img);
    */
