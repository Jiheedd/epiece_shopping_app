...
class AppColors{
  ...
  //static final Color mainColor = const Color(0xffeeb406);
  static final Color mainColor = kPrimaryColor;
  //static final Color mainColor = const Color(0xFFfa7552);
  static final Color greenSuccess = const Color(0xff0eaa11);
  static final Color BlueFacebook = const Color(0xff1556c9);
  static final Color darkBlue = const Color(0xff142f5f);
